...
public class GuardianNPCommandDispatcher :IGuardianNPContract
{
    ...
    {
        Logger.LogInformation("GuardianNPCommandDispatcher.StartVPNConnection: Calling VpnTransportIkeV2.StartVPNTunnelWithOptions...");
        _vpnTransportIkev2 = new VPNTransportIKEV2();
        var result = await _vpnTransportIkev2.StartVPNTunnelWithOptions(protocolRequest);
        Logger.LogInformation($"GuardianNPCommandDispatcher.StartVPNConnection: Return from VpnTransportIkeV2.StartVPNTunnelWithOptions. response: {result.IsError}");
    ...
    {
        _vpnTransportIkev2 = new VPNTransportIKEV2();
        Logger.LogInformation($"GuardianNPCommandDispatcher.DisconnectVPNConnection: stopping VPN entry '{ConnectionRoutines.ActiveConnectionEntryName}'");
    ...
    public CurrentVPNStatus GetCurrentVpnConnectionStatus()
    {
        ...
        Logger.Log(LogLevel.Information,$"GuardianNPCommandDispatcher.GetVpnConnectionStatus: IsAnyConnectionActive returned {anyConnectionActive}, Entry: '{entryOut}'");
