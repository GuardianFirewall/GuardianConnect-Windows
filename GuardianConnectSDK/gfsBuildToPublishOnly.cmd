...
msbuild /t:restore /p:Build /p:Configuration=Release /p:Platform=%1 /p:WarningLevel=0 /p:RuntimeIdentifier=win-%1 GuardianFirewallService\GuardianFirewallService.csproj
