...
#pragma warning disable CS0414
        ...
        {
	        foreach (string key in credDict.Keys)
	        {
		        switch (key)
		        {
			        case "Name":
        ...
        public GRDCredential InitWithTransportProtocol(ITransportProvider.TransportProtocol protocol, Dictionary<string, object> credDict, int validForDays, bool areMainCreds)
        {
	        GRDCredential self = new GRDCredential(credDict);
	        self.Name = "DEFAULTFILENAME"; // TJE FIGURE THIS RELEVANCY self.defaultFileName();
